 ...
 * @version 0.1
 */
public class SSSPPushDriver {
	
	public static void main(String[] args) throws Exception {
		// check the input parameters
		if (args.length != 9) {
			StringBuffer sb = 
				new StringBuffer("the sssp job must be given arguments(9):");
		...
		BSPJob bsp = new BSPJob(conf, SSSPPushDriver.class);
		...
		bsp.setInt(SPBSP.SOURCE, Integer.valueOf(args[8]));
