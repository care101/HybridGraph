...
import cn.edu.neu.termite.examples.pagerank.push.PageRankUserTool.PRGraphRecord;
import cn.edu.neu.termite.examples.pagerank.push.PageRankUserTool.PRMsgRecord;
...
public class PageRankBSP extends BSP {
	...
	public void compute(GraphContext context) throws Exception {
		...
		if (graphRecord.getGraphInfo().getEdgeNum() > 0) {
			graphRecord.setVerValue(value/graphRecord.getGraphInfo().getEdgeNum());
