 ...
 */
public class LPAUserTool extends UserTool<Integer, Integer, MsgBundle, EdgeSet> {
	
	public class LPAGraphRecord extends GraphRecord<Integer, Integer, MsgBundle, EdgeSet> {
		@Override
		...
		@Override
		public ArrayList<GraphRecord<Integer, Integer, MsgBundle, EdgeSet>> 
			...
			ArrayList<GraphRecord<Integer, Integer, MsgBundle, EdgeSet>> result = 
				new ArrayList<GraphRecord<Integer, Integer, MsgBundle, EdgeSet>>();
			for (dstTid = 0; dstTid < tNum; dstTid++) {
		...
		public MsgRecord<MsgBundle>[] getMsg(int iteStyle) {
			...
			LPAMsgRecord[] result = new LPAMsgRecord[eids.length];
	...
	public class LPAMsgRecord extends MsgRecord<MsgBundle> {
		...
		public int getMsgByte() {
			return this.msgValue==null? 8:(4+this.msgValue.getByteSize()); //vid + msgValue
		}
	...
	@Override
	public GraphRecord<Integer, Integer, MsgBundle, EdgeSet> getGraphRecord() {
